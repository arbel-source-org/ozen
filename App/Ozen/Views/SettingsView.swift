...
struct SettingsView: View {
    ...
    private var alertsSection: some View {
        Section {
            ...
            Text("רטט והדגשה כשנאמרת מילה חשובה; כרזה כשנשמע פעמון דלת, טלפון, אזעקה ועוד. כשהטלפון בכיס או נעול, אותן התראות מגיעות כהודעה בטלפון, וגם הודעה אם הכתוביות נעצרו ולא חזרו לבד.")
        }
        .task(id: scenePhase) {
