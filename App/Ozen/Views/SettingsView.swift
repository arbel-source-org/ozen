    ...
    private var siriSection: some View {
        Section {
            ...
            if #available(iOS 18.0, *) {
                ...
                Text("הפקודות עובדות גם מהמסך הנעול, וגם באוטומציות של אפליקציית קיצורי דרך. יש גם כפתור ״התחלת כתוביות״ למרכז הבקרה או לתחתית המסך הנעול, במקום הפנס או המצלמה: לחיצה ארוכה על מקום ריק במרכז הבקרה, ואז חיפוש ״אוזן״.")
            } else {
